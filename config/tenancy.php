...
return [
    'website' => [
         ...
         * to the application.
         * By default this id is randomized and fully
         ...
         * above.
         * You can override what generator to use by modifying this value
         ...
         * website.
         * Uses the above disk to store files to override system-wide
         * files.
         *
         ...
         * website changes.
         * This should not be too common, but in case it happens
         ...
         * contained within.
         *
         * @see @info set to true to enable.
         */
        'auto-delete-tenant-directory' => true,
        
        /**
         * Time to cache websites in minutes.
    ...
    'hostname' => [
         ...
         * identification.
         * The hostname identification is needed to
         ...
         * enable this flag.
         * This will run the tenant identification
        ...
        /**
         * Abort application execution in case no hostname was identified.
         * This will throw a
         ...
         */
        'abort-without-identified-hostname' => false, // if set to true then admin control panel that doesnt use tenancy breaks!!
        
        /**
         * Time to cache hostnames in minutes.
         * Set to false to disable.
         */
        'cache' => 10
    ],
    'db' => [
         ...
         * In Laravel this is normally configured to 'mysql'.
        ...
        /**
         * Used to give names to the system and tenant database connections.
         * By
         ...
         * connecting.
         * The default setup is to use a new database per tenant.
         ...
         * string used for tenants to connect to the specific database.
         * Do
        ...
        /**
         * The tenant migrations to be run during creation of a tenant.
         * Specify a directory
         * to run the migrations from.
         */
        'tenant-migrations-path' => storage_path('app/tenancy/migrations'),
