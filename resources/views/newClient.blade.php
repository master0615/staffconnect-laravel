			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form action="newClient" method="post">
						...
						<div class="form-group">
							<label for="url">Subdomain</label><br />https://<input
								type="text" class="form-control" id="url" name="url"
								placeholder="myagency">.staffconnect.net
						</div>

						<div class="form-group">
							<label for="email">Main Email</label><br />
							<input type="email" class="form-control" id="email" name="email"
								placeholder="eg. staff@myagency.com">
						</div>

						<div class="form-group">
							<label for="country_code">Country</label> <select
						...
						<div class="form-group">
							<label for="php_tz">Timezone</label> <select
								id='php_tz' name='php_tz' class="form-control">
								<?php 
								...
								foreach($zonelist as $i=>$tz){
								    echo"<option value='$i'>$tz</option>";
								}
								?>
							</select>
						</div>
